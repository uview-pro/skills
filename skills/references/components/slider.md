...
|start|滑块总体范围起点值|Number \| String|0|-|<BadgeVersion text="0.4.6" />|
|end|滑块总体范围终点值|Number \| String|100|-|<BadgeVersion text="0.4.6" />|
|showValue|是否显示滑块当前数值气泡|Boolean|false|true|<BadgeVersion text="0.4.6" />|
|valuePosition|滑块数值显示位置，top-上方，bottom-下方|'top' \| 'bottom'|top|bottom|<BadgeVersion text="0.4.6" />|
