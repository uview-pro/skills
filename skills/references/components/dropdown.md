---
name: "dropdown"
description: "该组件一般用于向下展开菜单，同时可切换多个选项卡的场景。. Invoke when user needs to use dropdown component in their uni-app project."
...
| show <BadgeVersion text="0.3.15" /> | 是否显示此选项卡 | Boolean | false | true |
