---
name: "calendar"
description: "此组件用于单个选择日期，范围选择日期等，日历被包裹在底部弹起的容器中。. Invoke when user needs to use calendar component in their uni-app project."
...
| show-lunar <BadgeVersion text="0.2.1" />| 是否显示农历 | Boolean | false | true |
